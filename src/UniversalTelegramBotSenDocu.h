...
#ifndef UniversalTelegramBotSenDocu_h
#define UniversalTelegramBotSenDocu_h
...
class UniversalTelegramBotSenDocu {
public:
  UniversalTelegramBotSenDocu(const String& token, Client &client);
  ...
  String sendPhotoByBinary(const String& chat_id,const String& fileName, const String& contentType, int fileSize,
    MoreDataAvailable moreDataAvailableCallback,
    GetNextByte getNextByteCallback, GetNextBuffer getNextBufferCallback, GetNextBufferLen getNextBufferLenCallback);
  String sendDocument(const String& chat_id,const String& fileName,const String& contentType, int fileSize,
    MoreDataAvailable moreDataAvailableCallback,
    GetNextByte getNextByteCallback, GetNextBuffer getNextBufferCallback, GetNextBufferLen getNextBufferLenCallback);
